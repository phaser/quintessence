...
if( CMAKE_HOST_APPLE )
 ...
 if ( EXISTS ${ANDROID_NDK}/prebuilt/darwin-x86_64/ )
     set( ANDROID_NDK_HOST_SYSTEM_NAME "darwin-x86_64")
 endif ()
elseif( CMAKE_HOST_WIN32 )
 set( ANDROID_NDK_HOST_SYSTEM_NAME "windows" )
 set( TOOL_OS_SUFFIX ".exe" )
 if ( EXISTS ${ANDROID_NDK}/prebuilt/windows-x86_64/ )
  set( ANDROID_NDK_HOST_SYSTEM_NAME "windows-x86_64" )
 endif()
elseif( CMAKE_HOST_UNIX )
 set( ANDROID_NDK_HOST_SYSTEM_NAME "linux-x86" )
 if ( EXISTS ${ANDROID_NDK}/prebuilt/linux-x86_64/ )
...
__INIT_VARIABLE( ANDROID_GENERATE_MAP_FILE VALUES ON )
set( ANDROID_GENERATE_MAP_FILE ON CACHE BOOL "Enables or disables generating map file" FORCE )
mark_as_advanced( ANDROID_GENERATE_MAP_FILE )
if( ANDROID_GENERATE_MAP_FILE )
 set( ANDROID_LINKER_FLAGS "-Wl,-Map,mapfile.map ${ANDROID_LINKER_FLAGS}" )
endif()
