...
get_target_value(${T} ${KRAL_PATH} KRAL_PATH_STR)
...
set (CMAKE_GENERATED_COMMAND "${CMAKE_GENERATED_COMMAND} -DNEW_CMAKE=1 -DPACKAGES=\"${PACKAGE_DIRS_STR}\" -DCMAKE_BUILD_TYPE=${BUILD_TYPE_${T}} -DKRAL_PATH=\"${KRAL_PATH_STR}\" -DPLATFORM=\"${PLATFORM_${T}}\" -G \"${PROJECT_TYPE_${T}}\" \"${PROJECT_DIR_${T}}\"")
...
if (GENERATE OR G)
    ...
    if (GENERATE_CMAKELISTS_${T})
        ...
        file (APPEND ${CMLFILE} "set (KRAL_PATH ${KRAL_PATH_STR} CACHE INTERNAL KRAL_PATH FORCE)\n")
