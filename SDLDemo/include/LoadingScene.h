...
#ifndef TESTGAME_DEV_INCLUDE_LOADINGSCENE_H_
#define TESTGAME_DEV_INCLUDE_LOADINGSCENE_H_
#include <IRenderScene.h>
#include <qui/cpp11compat.h>
#include <memory>
class LoadingScene : public qui::IRenderScene
{
    public:
        explicit LoadingScene(const qui::StandardGameEntry& game);
        ~LoadingScene();
        void render();
        bool init();
};
#endif  // TESTGAME_DEV_INCLUDE_LOADINGSCENE_H_
