...
#ifndef TESTGAME_DEV_INCLUDE_GAMEHUDSCENE_H_
#define TESTGAME_DEV_INCLUDE_GAMEHUDSCENE_H_
#include <IRenderScene.h>
#include <qui/cpp11compat.h>
#include <memory>
class GameHUDScene : public qui::IRenderScene
{
    public:
        explicit GameHUDScene(const qui::StandardGameEntry& game);
        ~GameHUDScene();
        void render();
        bool init();
};
#endif  // TESTGAME_DEV_INCLUDE_GAMEHUDSCENE_H_
