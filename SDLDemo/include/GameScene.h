...
#ifndef TESTGAME_DEV_INCLUDE_GAMESCENE_H_
#define TESTGAME_DEV_INCLUDE_GAMESCENE_H_
#include <IRenderScene.h>
#include <qui/cpp11compat.h>
#include <memory>
class GameScene : public qui::IRenderScene
{
    public:
        explicit GameScene(const qui::StandardGameEntry& game);
        ~GameScene();
        void render();
        bool init();
};
#endif  // TESTGAME_DEV_INCLUDE_GAMESCENE_H_
