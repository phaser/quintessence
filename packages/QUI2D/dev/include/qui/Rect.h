 ...
 */
#ifndef PACKAGES_QUI_QUI2D_DEV_INCLUDE_QUI_RECT_H_
#define PACKAGES_QUI_QUI2D_DEV_INCLUDE_QUI_RECT_H_
...
{
 public:
    static Rect* getObject(const glm::vec2& p1, const glm::vec2& p2, const glm::vec4& color);
    void paint();
...
#endif  // PACKAGES_QUI_QUI2D_DEV_INCLUDE_QUI_RECT_H_
