...
#ifndef PACKAGES_QUI_QUIINPUT_DEV_INCLUDE_QUI_INPUTINTERFACE_H_
#define PACKAGES_QUI_QUIINPUT_DEV_INCLUDE_QUI_INPUTINTERFACE_H_
#include <memory>
namespace qui
{
namespace input
...
class InputInterface
{
 ...
 private:
     InputInterface(const InputInterface& /*other*/)  // no copy allowed
     {
     }
     static std::auto_ptr<EventStore> eventStore;
};
}  // namespace input
}  // namespace qui
#endif  // PACKAGES_QUI_QUIINPUT_DEV_INCLUDE_QUI_INPUTINTERFACE_H_
